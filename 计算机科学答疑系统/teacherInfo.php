		...
		<div class="row">
			...
			<div class="col-md-9">
				...
				while($row=mysql_fetch_array($result,MYSQL_ASSOC)){
					...
					echo '<img class="img-circle" src="img/'.$row['Id'].'.jpg" alt="" width="150" height="150"><br>';
					echo '</div>';
					echo '<div class="col-lg-1"></div>';
					}
					echo '<div class="col-lg-9">';
					echo '<p><h4>'.$row['Name'].'</h4></p>';
					echo '<p><h4>答疑方向：'.$row['Class'].'</h4></p>';
					echo '<p><h4>'.$row['introduce'].'</h4></p>';
					echo '</div>';
					if($ctrl==-1){
					echo '<div class="col-lg-1"></div>';
					echo '<div class="col-lg-2">';
