...
if($_COOKIE['authority']!="student"){
	echo ("<script>alert('错误！');window.location=\"login.php\"</script>");
}
if(!isset($_GET['id'])){
	...
	<body>
		...
		<div class="row">
			...
			<div class="col-md-9">
				...
				<div class="col-md-10">
					<form method="post" action="chgquestion.php?id=<?php echo $_GET['id']; ?>" class="form-horizontal">
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" name="Question" class="form-control" id="Question" value="<?php echo $row['question'] ?>"></input>
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<textarea name="Describe" class="form-control" rows="4"><?php echo $row['describe'] ?></textarea>																																								
							</div>
						</div>
						<div class="form-group">
							<label for="answer" class="col-sm-2 control-label">答案:</label>
							<div class="col-sm-10">
								<textarea name="answer" class="form-control" rows="10"><?php echo $row['answer'] ?></textarea>																																								
							</div>
						</div>
